...
def get_eod_data(symbol = "AAPL.US", api_token = key):
	...
	for x in lst1:
		...
		cols = ["ask","bid","change","changePercent","contractName","contractSize",
		"currency","delta","lastTradeDateTime","rho","theta","gamma","intrinsicValue",
...
def transform_dfs(df_puts,df_calls):
	...
	cols = ["expirationDate","type","strike","inTheMoney","lastPrice","volume"]
	to_floats = ["strike","lastPrice","volume"]
